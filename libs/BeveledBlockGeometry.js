	...
	function buildPlane( u, v, udir, vdir, width, height, depth, materialIndex ) {
		...
		for ( iy = 0; iy < gridY; iy++ ) {
			...
			for ( ix = 0; ix < gridX; ix++ ) {
				...
				var face1 = new THREE.Face3( a + offset, b + offset, c + offset);
				var face2 = new THREE.Face3( a + offset, c + offset, d + offset);
				// not needed? We don't compute others: face.normal.copy( normal );
				face1.vertexNormals.push( normal.clone(), normal.clone(), normal.clone(), normal.clone() );
